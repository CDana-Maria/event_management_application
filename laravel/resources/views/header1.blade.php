          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto ">
              <li class="nav-item effect">
                <a class="nav-link" href="{!! url('/services/all'); !!}" target="_blank">Products</a>
              </li>
              <li class="nav-item effect">
                <a class="nav-link " href="{!! url('/about'); !!}" target="_blank">About</a>
              </li>
              <li class="nav-item effect">
                <a class="nav-link" href="{!! url('/contact'); !!}" target="_blank">Contact</a>
              </li>
              <li class="nav-item effect cart">
                <a class="nav-link" href="{!! url('/cart'); !!}" target="_blank">
